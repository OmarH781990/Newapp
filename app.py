...
# File Upload for Directional Survey
...
if survey_file:
    ...
    well_name_col = st.sidebar.selectbox("Select Well Name Column",survey_columns)
    st.write(survey_data.columns)
   ...
   # st.write(selected_well)
        ...
        st.write("TVD Calculation Completed")
